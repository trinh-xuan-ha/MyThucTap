...
export default function ImagePage() {
  ...
  return (
    <div className="z-10">
      <div key={currentImageIndex} className="relative z-10">
        <Image
          className="max-w-max z-10  w-full h-[940px] image-container"
        ...
        <div className="absolute top-1/2 left-10 transform -translate-y-1/2 w-72">
          ...
          <button className="px-9 py-5 hover:bg-red-500 transition-colors duration-300 bg-white text-black rounded-md">
            Show now
          </button>
        </div>
      </div>
